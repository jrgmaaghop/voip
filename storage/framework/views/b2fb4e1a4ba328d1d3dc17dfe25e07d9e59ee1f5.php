  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <?php endif; ?>
        <div class="col-md-12 col-sm-12 col-xs-12">
          <form method="POST" action="<?php echo e(route('criteria.update',$data['criteria']->id)); ?>" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal form-label-left"  novalidate>
            <?php echo csrf_field(); ?>
            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="round_id">Group <span class="required">*</span>
              </label>
              <div  class="col-md-6 col-sm-6 col-xs-12">
                <select id="round_id" name="round_id" class="form-control col-md-7 col-xs-12" required>
                  ...
                  <option value="<?php echo e($key); ?>" <?php echo ($data['criteria']->round_id==$key)?'selected':'' ?>><?php echo e($round); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="title" class="form-control col-md-7 col-xs-12" name="title" value="<?php echo e($data['criteria']->desc); ?>" placeholder="Criteria Title" required="required" type="text" required>
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="number" id="rating" name="rating" value="<?php echo e($data['criteria']->rate); ?>" required="required" data-validate-minmax="0,101" class="form-control col-md-7 col-xs-12" required>
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="number" id="max_score" name="max_score" value="<?php echo e($data['criteria']->max_score); ?>" required="required" data-validate-minmax="0,11" class="form-control col-md-7 col-xs-12" required>
              </div>
            </div>
