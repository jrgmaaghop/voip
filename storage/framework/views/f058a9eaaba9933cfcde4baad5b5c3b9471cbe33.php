...
<?php $__env->startSection('content'); ?>
  <div class="x_panel">
    <div class="x_title">
      <h2><i class="fa fa-bar-chart"></i> Results<small></small></h2>
          ...
          <div id="collapse-round-<?php echo e($cpr['round_info']->id); ?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading-round-<?php echo e($cpr['round_info']->id); ?>">
            <div class="panel-body">
              <div class="buttons">
                ...
                <a href="<?php echo e(route('results-score',[$ci->id,$cpr['round_info']->id,Auth::user()->id])); ?>" class="btn btn-default btn-lg btn-block"><?php echo e($ci->desc); ?></a>
