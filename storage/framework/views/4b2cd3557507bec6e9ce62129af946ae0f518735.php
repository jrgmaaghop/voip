    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        <div class="col-md-3 col-sm-3 col-xs-12">
          <img id="candidate-pic-display" class="img-thumbnail" src="<?php echo e(asset('images/candidates/default.jpg')); ?>" alt="logo">
        </div>

        <div class="col-md-9 col-sm-9 col-xs-12">
          <form method="POST" action="<?php echo e(route('candidates.store')); ?>" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal form-label-left"  novalidate>
            <?php echo csrf_field(); ?>
            ...
            <div class="item form-group">
              ...
              <div  class="col-md-6 col-sm-6 col-xs-12">
                <select id="team" name="team" class="form-control col-md-7 col-xs-12" required>
                  ...
                  <option value="<?php echo e($key); ?>"><?php echo e($team); ?></option>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="number" id="candidate_number" name="candidate_number" required="required" data-validate-minmax="1,20" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="candidate_name" class="form-control col-md-7 col-xs-12" name="candidate_name" placeholder="Candidate Name" required="required" type="text">
              </div>
            </div>
            <div class="item form-group">
